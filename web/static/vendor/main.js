...
Elm.IntegerInput = Elm.IntegerInput || {};
Elm.IntegerInput.make = function (_elm) {
   "use strict";
   _elm.IntegerInput = _elm.IntegerInput || {};
   if (_elm.IntegerInput.values) return _elm.IntegerInput.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var viewDisplay = F2(function (address,model) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("editable-label"),A2($Html$Events.onDoubleClick,address,EnterEdit)]),
      _U.list([$Html.text($Basics.toString(model.value))]));
   });
   ...
   var viewEdit = F2(function (address,model) {
      ...
      _U.list([$Html$Attributes.$class("editable-label")
              ,$Html$Attributes.value($Basics.toString(model.value))
   ...
   var update = F2(function (action,model) {
      ...
      {case "EnterEdit": return _U.update(model,{state: Edit});
         ...
         case "UpdateValue": var newValueResult = $String.toInt(_p2._0);
           var _p3 = newValueResult;
           if (_p3.ctor === "Ok") {
                 return _U.update(model,{value: _p3._0});
              } else {
                 return model;
              }
         default: return model;}
   });
   var main = $StartApp$Simple.start({model: init(0),view: view,update: update});
   return _elm.IntegerInput.values = {_op: _op
                                     ,main: main
                                     ,Display: Display
                                     ,Edit: Edit
                                     ,Model: Model
...
Elm.MoreHtmlEvents = Elm.MoreHtmlEvents || {};
Elm.MoreHtmlEvents.make = function (_elm) {
   "use strict";
   _elm.MoreHtmlEvents = _elm.MoreHtmlEvents || {};
   if (_elm.MoreHtmlEvents.values) return _elm.MoreHtmlEvents.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var onChange = F2(function (address,contentToValue) {
      return A3($Html$Events.on,"change",$Html$Events.targetValue,function (str) {    return A2($Signal.message,address,contentToValue(str));});
   });
   var onDrop = F2(function (address,message) {
      return A3($Html$Events.on,"drop",$Json$Decode.value,function (_p0) {    return A2($Signal.message,address,message);});
   });
   var onDragOver = F2(function (address,message) {
      var options = {stopPropagation: true,preventDefault: true};
      return A4($Html$Events.onWithOptions,"dragover",options,$Json$Decode.value,function (_p1) {    return A2($Signal.message,address,message);});
   });
   var onDrag = F2(function (address,message) {
      return A3($Html$Events.on,"drag",$Json$Decode.value,function (_p2) {    return A2($Signal.message,address,message);});
   });
   return _elm.MoreHtmlEvents.values = {_op: _op,onDrag: onDrag,onDragOver: onDragOver,onDrop: onDrop,onChange: onChange};
};
Elm.Mui = Elm.Mui || {};
Elm.Mui.make = function (_elm) {
   ...
   var idForValue = F2(function (value,model) {
      ...
      if (_p6.ctor === "Nothing") {
            ...
            return $Maybe.Just($Basics.fst(_p6._0));
         }
   });
...
Elm.Issue.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var UpdateProcessed = F4(function (a,b,c,d) {    return {ctor: "UpdateProcessed",_0: a,_1: b,_2: c,_3: d};});
   var effectUpdateIssue = F4(function (key,role,maybeNewName,maybePreviousName) {
      var roleString = function () {    var _p0 = role;if (_p0.ctor === "Developer") {    return "developer";} else {    return "reviewer";}}();
      var body = $Http.multipart(_U.list([A2($Http.stringData,roleString,A2($Maybe.withDefault,"",maybeNewName))]));
      var url_base = A2($Basics._op["++"],"/api/issues/",key);
      var url = A2($Http.url,url_base,_U.list([]));
      return $Effects.task(A2($Task.map,A3(UpdateProcessed,role,maybeNewName,maybePreviousName),$Task.toMaybe(A3($Http.post,$Json$Decode.string,url,body))));
   });
   var update = F2(function (action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "Assign": var _p3 = _p1._0;
           var selectedTeamMemberName = $Mui.selectedID(_p1._1);
           var _p2 = _p3;
           if (_p2.ctor === "Developer") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{isBeingUpdated: true,developerName: selectedTeamMemberName})
                        ,_1: A4(effectUpdateIssue,model.key,_p3,selectedTeamMemberName,model.developerName)};
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{isBeingUpdated: true,reviewerName: selectedTeamMemberName})
                        ,_1: A4(effectUpdateIssue,model.key,_p3,selectedTeamMemberName,model.reviewerName)};
              }
         case "Unassign": var _p5 = _p1._0;
           var _p4 = _p5;
           if (_p4.ctor === "Developer") {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{isBeingUpdated: true,developerName: $Maybe.Nothing})
                        ,_1: A4(effectUpdateIssue,model.key,_p5,$Maybe.Nothing,model.developerName)};
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{isBeingUpdated: true,reviewerName: $Maybe.Nothing})
                        ,_1: A4(effectUpdateIssue,model.key,_p5,$Maybe.Nothing,model.reviewerName)};
              }
         default: var _p6 = _p1._3;
           if (_p6.ctor === "Just" && _p6._0 === "ok") {
                 return {ctor: "_Tuple2",_0: _U.update(model,{isBeingUpdated: false}),_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{isBeingUpdated: false}),_1: $Effects.none};
              }}
   });
   ...
   var view = F3(function (address,model,teamMemberNames) {
      ...
      _U.list([A2($Html.td,
              ...
              ,A2($Html.td,_U.list([]),_U.list([A4($Mui.selectBox,A2($Signal.forwardTo,address,Assign(Developer)),"None",options,model.developerName)]))
              ,A2($Html.td,_U.list([]),_U.list([A4($Mui.selectBox,A2($Signal.forwardTo,address,Assign(Reviewer)),"None",options,model.reviewerName)]))]));
   });
...
Elm.StringInput = Elm.StringInput || {};
Elm.StringInput.make = function (_elm) {
   "use strict";
   _elm.StringInput = _elm.StringInput || {};
   if (_elm.StringInput.values) return _elm.StringInput.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.StringInput.values = {_op: _op
                                    ,main: main
                                    ,Display: Display
                                    ,Edit: Edit
                                    ,Model: Model
...
Elm.MathUtils = Elm.MathUtils || {};
Elm.MathUtils.make = function (_elm) {
   "use strict";
   _elm.MathUtils = _elm.MathUtils || {};
   if (_elm.MathUtils.values) return _elm.MathUtils.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var floatRound = F2(function (value,decimals) {
      var floatDecimals = $Basics.toFloat(decimals);
      return $Basics.toFloat($Basics.round(value * 10 * floatDecimals)) / (floatDecimals * $Basics.toFloat(10));
   });
   return _elm.MathUtils.values = {_op: _op,floatRound: floatRound};
};
...
Elm.SprintPlanning.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html.legend,_U.list([]),_U.list([$Html.text("Sprint")]))
                              ...
                              _U.list([A2($Html.div,
                                      ...
                                      _U.list([$Html$Attributes.type$("text")
                                              ,$Html$Attributes.placeholder("Enter a sprint name")
                                              ,A3($Html$Events.on,
                                              "input",
                                              $Html$Events.targetValue,
                                              function (str) {
                                                 return A2($Signal.message,address,UpdateSprintName(str));
                                              })]),
                                      _U.list([]))]))]))
                                      ,A2($Html.div,
                                      _U.list([$Html$Attributes.$class("mui-col-md-6")]),
                      ...
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("mui-panel")]),
                      _U.list([A2($Html.div,_U.list([]),_U.list([A3(viewIssues,address,issuesTodo,teamMemberNames)]))]))
                      ,A2($Html.h2,_U.list([]),_U.list([$Html.text("Issues - DONE")]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("mui-panel")]),
                      _U.list([A2($Html.div,_U.list([]),_U.list([A3(viewIssues,address,issuesDone,teamMemberNames)]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("team-members-box mui-col-md-4")]),
   ...
   return _elm.SprintPlanning.values = {_op: _op
                                       ...
                                       ,effectFetchIssues: effectFetchIssues
...
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $SprintPlanning.init,update: $SprintPlanning.update,view: $SprintPlanning.view,inputs: _U.list([])});
   var main = app.html;
